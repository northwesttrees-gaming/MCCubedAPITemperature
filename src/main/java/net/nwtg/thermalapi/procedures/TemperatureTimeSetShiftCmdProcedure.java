...
public class TemperatureTimeSetShiftCmdProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (!world.isClientSide()) {
			...
			if (file.exists()) {
				timeShift = DoubleArgumentType.getDouble(arguments, "timeShift");
				{
					try {
						...
						mainObject.addProperty("shift", timeShift);
						{
				...
				if (entity instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(Component.literal((("\u00A76" + "[" + "ThermalAPI" + "] " + "\u00A7f") + "" + ("The time temperature shift setting is set to: " + "\u00A7a" + timeShift + "\u00A7f" + "."))), false);
			}
		}
	}
}
